...
describe('Component Tests', () => {
  describe('CweList Management Component', () => {
    let comp: CweListComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(CweListComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.cweLists?.[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
